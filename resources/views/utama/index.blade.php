                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h6 class="display-2 text-white animated slideInDown mb-2 ">Temukan Kategori Kursus Unik Disini
                                </h6>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Klik gambar untuk melihat kategori kursus unik hanya di SIPTKA.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <div class="card-img-top content-ratio" style="background-image: url('{{ asset('gambar/tempatkursus/foto-utama/' . $kursus->foto_utama) }}');">
                    </div>
                    <div class="card-body">
        ...
        <div class="text-center mt-4 wow fadeInUp" data-wow-delay="0.1s">
            <a href="{{ route('utama.search') }}" style="
