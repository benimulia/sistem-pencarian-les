...
@section('content')
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-sm-6">
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="{{ route('utama.about') }}">Read
                                More</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="text-center mt-4 wow fadeInUp" data-wow-delay="0.1s">
                <a href="{{ route('utama.jeniskategoriumum') }}" class="btn btn-primary">Lihat Selengkapnya</a>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle" src="{{ asset('gambar/icon kategori.png  ') }}"
                                    alt="" style="width: 100%; aspect-ratio: 3/2; object-fit:contain;">
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                                <a class="d-block text-center h3 mt-3 mb-4"
                                    href="{{ route('utama.kategori', ['id' => $result->id_kategori]) }}">{{ $result->nama_kategori }}</a>
            ...
            <div class="text-center mt-4 wow fadeInUp" data-wow-delay="0.1s">
                <a href="{{ route('utama.jeniskategoriunik') }}" class="btn btn-primary">Lihat Selengkapnya</a>
            </div>
