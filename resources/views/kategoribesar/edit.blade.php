...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <form name="kategoribesarForm" action="{{ route('kategoribesar.update', ['id' => $kategori->id_kategori_besar]) }}" class="needs-validation" novalidate method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" id="id_kategori_utama" name="id_kategori_utama" disabled=true>
                    <option value="">Pilih Kategori Utama</option>
                    @foreach ($kategoriutama as $index => $result)
                    <option value="{{ $result->id_kategori_utama }}" {{ $kategori->id_kategori_utama == $result->id_kategori_utama ? 'selected' : '' }}>{{ $result->nama_kategori_utama }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_kategori_besar" placeholder="Masukkan nama kategori besar" name="nama_kategori_besar" required value="{{ $kategori->nama_kategori_besar }}" disabled=true>
