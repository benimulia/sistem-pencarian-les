    ...
    <div class="col-sm-12 col-md-12">
        ...
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a>Ubah Tempat Kursus</a></li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <form name="tempatkursusForm" action="{{ route('tempatkursus.update', ['id' => $tempatkursus->id_tempat_kursus]) }}" class="needs-validation" novalidate method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" id="id_user" name="id_user" disabled=true>
                    ...
                    <option value="{{ $result->id }}" {{ $tempatkursus->id_user == $result->id ? 'selected' : '' }}>{{ $result->name }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" id="id_kategori" name="id_kategori[]" multiple="multiple" required disabled=true>
                    ...
                    <option value="{{ $result->id_kategori }}" {{ in_array($result->id_kategori, $tempatkursus->kategori->pluck('id_kategori')->toArray()) ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_tempat_kursus" placeholder="Masukkan nama.." name="nama_tempat_kursus" required value="{{ $tempatkursus->nama_tempat_kursus }}" disabled=true>
                <div class="valid-feedback">
                    Terlihat bagus!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="alamat" placeholder="Masukkan alamat.." name="alamat" required value="{{ $tempatkursus->alamat }}" disabled=true>
                <div class="valid-feedback">
                    Terlihat bagus!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="no_telp" placeholder="Masukkan no telp.." name="no_telp" maxlength="13" required value="{{ $tempatkursus->no_telp }}" disabled=true>
                <div class="valid-feedback">
                    Terlihat bagus!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="instagram" placeholder="Masukkan username instagram.." name="instagram" required value="{{ $tempatkursus->instagram }}" disabled=true>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="facebook" placeholder="Masukkan facebook.." name="facebook" required value="{{ $tempatkursus->facebook }}" disabled=true>
                <small>contoh : UKDW Yogyakarta </small>
                <div class="valid-feedback">
                    Terlihat bagus!
                </div>
            ...
            <div class="form-group">
                <label for="foto_utama">Unggah foto utama tempat kursus :</label> <br>
                <div class="custom-file">
                    <input type="file" class="custom-file-input form-control" id="foto_utama" name="foto_utama" accept=".jpg,.jpeg,.png" disabled=true />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <a href="/gambar/tempatkursus/foto-utama/{{ $tempatkursus->foto_utama }}">
                    <img src="/gambar/tempatkursus/foto-utama/{{ $tempatkursus->foto_utama }}" style="width: 10%; aspect-ratio: 3/2; object-fit: contain;" id="profile-img-tag">
                </a>
                @else
            ...
            <div class="" style="margin-top: 30px;">
                <a href="{{ route('tempatkursus.edit', ['id' => $tempatkursus->id_tempat_kursus]) }}" id="btnBatal" class="btn btn-danger mr-2" style="display: none;">Batal</a>
