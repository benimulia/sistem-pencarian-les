                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('kategori.edit',['id' => $result->id_kategori]) }}"
                        ...
                        @can('kategori-delete')
                        <td class="text-center">
                            <a data-id="{!! $result->id_kategori !!}"
                                data-target="#previewModal-{{ $result->id_kategori }}" data-toggle="modal"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ route('kategori.destroy',['id' => $result->id_kategori]) }}"
