...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <form name="programForm" action="{{ route('program.update', ['id' => $program->id_program]) }}" class="needs-validation" novalidate method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_program" placeholder="Masukkan nama program.." name="nama_program" required value="{{ $program->nama_program }}" disabled=true>
                <div class="valid-feedback">
                    Terlihat Bagus!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" id="deskripsi_program" placeholder="Masukkan deskripsi.." name="deskripsi_program" required value="{{ $program->deskripsi_program }}" disabled=true> {{ $program->deskripsi_program }} </textarea>
                <div class="valid-feedback">
                    Terlihat Bagus!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="harga" placeholder="Masukkan harga.." name="harga" required value="{{ $program->harga }}" disabled=true>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jadwal" placeholder="Masukkan jadwal program.." name="jadwal" required value="{{ $program->jadwal }}" disabled=true>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="durasi" placeholder="Masukkan durasi program.." name="durasi" required value="{{ $program->durasi }}" disabled=true>
            ...
            <div class="form-group">
                <label for="foto_program">Unggah foto program :</label> <br>
                <div class="custom-file">
                    <input type="file" class="custom-file-input form-control" id="foto_program" name="foto_program" accept=".jpg,.jpeg,.png" disabled=true />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 ">
                ...
                <a href="/gambar/tempatkursus/foto-program/{{ $program->foto_program }}">
                    <img src="/gambar/tempatkursus/foto-program/{{ $program->foto_program }}" style="width: 10%; aspect-ratio: 3/2; object-fit:contain;" id="profile-img-tag">
                </a>
            </div>

            <div class="" style="margin-top: 30px;">
                <a href="{{ route('program.edit', ['id' => $program->id_program]) }}" id="btnBatal" class="btn btn-danger mr-2" style="display: none;">Batal</a>
